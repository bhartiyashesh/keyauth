...
declare module '#imports' {
  ...
  export { default as CodeView } from '../src/components/CodeView';
  export { default as ConnectedView } from '../src/components/ConnectedView';
  export { default as PairingView } from '../src/components/PairingView';
